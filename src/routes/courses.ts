...
//admin
coursesRoute.get('/api/admin/courses/get',extractJWT, controller.getAllCourses);
coursesRoute.get('/api/admin/courses/get/:id',extractJWT, controller.retrieveCourses);
coursesRoute.post('/api/admin/courses/create',extractJWT, upload, extractRequest(CoursesSchema), controller.addCourses);
